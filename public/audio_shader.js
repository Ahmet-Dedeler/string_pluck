  ...
  `;
    ...
    let createAudio = () => {
        ...
        node.onaudioprocess = (e) => {
            ...
            const bufferDurationSeconds = samples / this.audioCtx.sampleRate;
            if (typeof window.advanceMidiFromAudio === 'function') {
                window.advanceMidiFromAudio(bufferDurationSeconds);
            }
    ...
    this.destroy = async function () {
        ...
        this.audioCtx.close();
        if (typeof window.setMidiSchedulerSource === 'function') {
            window.setMidiSchedulerSource('frame');
        }
        // destroy shaders
    }
